...
function spawnMonsters() {
    if (frameCount % 170 === 0) {
        var monster = createSprite(0,windowWidth/2-350,40,40);
        //monster.debug=true;
...
function spawnObstacles() {
    if (frameCount % 350 === 0) {
        var obstacle = createSprite(2600,windowWidth/2-350,40,40);
        //obstacle.debug=true;
...
function spawnCoins() {
    if (frameCount % 400 === 0) {
        coin = createSprite(2600,windowWidth/2-350,40,40);
        //coin.debug=true;
